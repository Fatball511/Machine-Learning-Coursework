load("Final_model_1.mat")
%% Run this section to use testing set
% Split testing set into independent X and Y

Truelabel = dataTest_Y{:,:};%convert testing set from table to array

% Use testing set on new model to get prediction
[predictedlabel,score] = predict(newMdl.Trained{10},dataTest_X);
...
rocObj = rocmetrics(Truelabel,score,newMdl.ClassNames);
